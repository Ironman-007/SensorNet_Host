...
int NUM_NODES = sizeof(NODE_ADDRESSES) / sizeof(NODE_ADDRESSES[0]);
...
void loop() {
  for (int node = 0; node < NUM_NODES; node++) {
    ...
    Wire.requestFrom(NODE_ADD, 56);  // request 56 bytes from the current node
    ...
    if(deviceID ==4) {//bot,right,top, left
    ...
    temp = ((float)((c[11]<<8) + c[10]))/100;
    pres = ((float)((c[13]<<8) + c[12]))/100;
    hum  = ((float)((c[15]<<8) + c[14]))/100;

    Serial.print(temp); Serial.print(",");
    Serial.print(pres); Serial.print(",");
    Serial.print(hum);  Serial.print(",");

    quat_w = ((float)((c[19]<<24) + (c[18]<<16) + (c[17]<<8) + c[16]))/100;
    quat_x = ((float)((c[23]<<24) + (c[22]<<16) + (c[21]<<8) + c[20]))/100;
    quat_y = ((float)((c[27]<<24) + (c[26]<<16) + (c[25]<<8) + c[24]))/100;
    quat_z = ((float)((c[31]<<24) + (c[30]<<16) + (c[29]<<8) + c[28]))/100;
    ...
    accel_x = ((float)((c[35]<<24) + (c[34]<<16) + (c[33]<<8) + c[32]))/100;
    accel_y = ((float)((c[39]<<24) + (c[38]<<16) + (c[37]<<8) + c[36]))/100;
    accel_z = ((float)((c[43]<<24) + (c[42]<<16) + (c[41]<<8) + c[40]))/100;

    Serial.print(accel_x); Serial.print(",");
    Serial.print(accel_y); Serial.print(",");
    Serial.print(accel_z); Serial.print(",");

    magnet_x = ((float)((c[47]<<24) + (c[46]<<16) + (c[45]<<8) + c[44]))/100;
    magnet_y = ((float)((c[51]<<24) + (c[50]<<16) + (c[49]<<8) + c[48]))/100;
    magnet_z = ((float)((c[55]<<24) + (c[54]<<16) + (c[53]<<8) + c[52]))/100;
